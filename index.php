...
<body>
    ...
    <div class="container">
        <div class="tab">
            <button class="tablink active" onclick="openTab(event,'signin')" id="link1">Se connecter</button>
            <button class="tablink" onclick="openTab(event,'signup')" id="link2">S'inscrire</button>
        </div>
        <div class="content">
            ...
            <div class="tabcontent" id="signup">
                <form method="post" onsubmit="return validateRegister()">
                    ...
                    <br>
                    <!--Last Name-->
                    <label>Nom de famille<span>*</span></label><br>
                    ...
                    <br>
                    <!--Confirm Password-->
                    <label>Confirmer mot de passe<span>*</span></label><br>
