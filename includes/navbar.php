<div class="usernav">
    ...
    <ul> <!-- Ensure there are no enter escape characters.-->
        <li><a href="requests.php">Requete (<?php echo $row['count'] ?>)</a></li><li><a href="profile.php">Profile</a></li><li><a href="friends.php">Amis</a></li><li><a href="home.php">Acceuil</a></li><li><a href="logout.php">Déconnexion</a></li>
    </ul>
    <div class="globalsearch">
        <form method="get" action="search.php" onsubmit="return validateField()"> <!-- Ensure there are no enter escape characters.-->
            <select name="location">
                ...
                <option value="hometowns">Ville</option>
